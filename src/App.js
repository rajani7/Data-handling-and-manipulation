...
function App() {
  ...
  const friendsData = [
    ...
    { id: 3, name: "monica", quote: "Damn the jellyfish!" },
    { id: 4, name: "chandler", quote: "I'm not great at advice" },
    { id: 5, name: "rachel", quote: "It’s a metaphor, Daddy." },
  ];
  const options = [
  ...
  return (
    <div className="App">
      ...
      <div className="dropdown-section">
        <select className="dropdown-list" onChange={(e)=> {setValue(e.target.value)}}>
          {options.map((option) => (
